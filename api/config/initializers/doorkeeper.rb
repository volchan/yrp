...
Doorkeeper.configure do
  ...
  before_successful_authorization do |controller, _context|
    controller.request.params.deep_transform_keys!(&:underscore)
  end
...
Doorkeeper::JWT.configure do
  ...
  # JWK can be used to automatically verify RS* tokens client-side
  # if token's kid matches a public kid in /oauth/discovery/keys
...
module CustomTokenResponse
  def body
    DoorkeeperTokenSerializer.one(token)
  end
end
